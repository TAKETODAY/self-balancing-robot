...
import static cn.taketoday.robot.protocol.format.MessagePackCode.ARRAY16;
import static cn.taketoday.robot.protocol.format.MessagePackCode.ARRAY32;
import static cn.taketoday.robot.protocol.format.MessagePackCode.BIN16;
import static cn.taketoday.robot.protocol.format.MessagePackCode.BIN32;
import static cn.taketoday.robot.protocol.format.MessagePackCode.BIN8;
import static cn.taketoday.robot.protocol.format.MessagePackCode.EXT8;
import static cn.taketoday.robot.protocol.format.MessagePackCode.EXT_TIMESTAMP;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FALSE;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FIXARRAY_PREFIX;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FIXEXT4;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FIXEXT8;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FIXMAP_PREFIX;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FIXSTR_PREFIX;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FLOAT32;
import static cn.taketoday.robot.protocol.format.MessagePackCode.FLOAT64;
import static cn.taketoday.robot.protocol.format.MessagePackCode.INT16;
import static cn.taketoday.robot.protocol.format.MessagePackCode.INT32;
import static cn.taketoday.robot.protocol.format.MessagePackCode.INT64;
import static cn.taketoday.robot.protocol.format.MessagePackCode.INT8;
import static cn.taketoday.robot.protocol.format.MessagePackCode.MAP16;
import static cn.taketoday.robot.protocol.format.MessagePackCode.MAP32;
import static cn.taketoday.robot.protocol.format.MessagePackCode.NIL;
import static cn.taketoday.robot.protocol.format.MessagePackCode.STR16;
import static cn.taketoday.robot.protocol.format.MessagePackCode.STR32;
import static cn.taketoday.robot.protocol.format.MessagePackCode.STR8;
import static cn.taketoday.robot.protocol.format.MessagePackCode.TRUE;
import static cn.taketoday.robot.protocol.format.MessagePackCode.UINT16;
import static cn.taketoday.robot.protocol.format.MessagePackCode.UINT32;
import static cn.taketoday.robot.protocol.format.MessagePackCode.UINT64;
 ...
 * the MessagePack encoding, including choosing the most compact format for numbers
 * and other data types.
 *
 * <p><b>Usage Example:</b>
 * <pre>{@code
 * ByteBuf buffer = Unpooled.buffer();
 * MessagePackOutput output = new MessagePackOutput(buffer);
 *
 * // Writing a map
 * output.writeMapHeader(2);
 *
 * output.write("name");
 * output.write("John Doe");
 *
 * output.write("age");
 * output.write(30);
 * }</pre>
 *
 * This implementation is not thread-safe. Each thread should have its own instance
