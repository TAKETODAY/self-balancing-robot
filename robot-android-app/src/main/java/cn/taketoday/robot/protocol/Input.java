...
public interface Input {
  ...
  /**
   * Reads an {@link Enumerable} value of type {@code V} from the input.
   *
   * @param <V> the type of the enumerable value, which must extend {@link Enumerable<Integer>}
   * @param type the {@link Class} object of type {@code V}
   * @return an enumerable value of type {@code V} read from the input
   * @throws SerializationException if a serialization error occurs
   */
