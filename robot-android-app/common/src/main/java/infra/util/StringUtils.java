...
public abstract class StringUtils {
  ...
  public static Set<String> commaDelimitedListToSet(@Nullable String str) {
    ...
    return CollectionUtils.newLinkedHashSet(tokens);
  }
  ...
  public static Locale parseLocaleString(@Nullable String localeString) {
    ...
    throw new IllegalArgumentException(String.format("Invalid locale format: '%s'", localeString));
  }
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (ch != ' ' && ch != '_' && ch != '-' && ch != '#' && !Character.isLetterOrDigit(ch)) {
        throw new IllegalArgumentException(
                String.format("Locale part \"%s\" contains invalid characters", localePart));
      }
    }
  }
