...
/**
 * A factory interface for creating instances of {@link infra.util.concurrent.Scheduler}. This interface
 ...
 * }</pre>
 *
 * <p><b>Note:</b> The {@link infra.util.concurrent.Scheduler#lookup()} method can be used as an alternative
 ...
 * @see infra.util.concurrent.Scheduler
 * @since 4.0 2024/2/28 13:24
 */
public interface SchedulerFactory {

  /**
   * Creates and returns a new instance of {@link infra.util.concurrent.Scheduler}. This method is typically
   ...
   *
   * @return a new instance of {@link infra.util.concurrent.Scheduler}, which can be used to execute tasks
   * asynchronously or after a specified delay
   * @see infra.util.concurrent.Scheduler
   * @see infra.util.concurrent.Scheduler#lookup()
   */
  Scheduler create();
