...
public class ListenableFutureTask<V> extends AbstractFuture<V> implements RunnableFuture<V> {
  ...
  protected String notCompletedString() {
    ...
    return task == null ? "[Not completed]" : String.format("[Not completed, task = %s]", task);
  }
  ...
  private static final AtomicReferenceFieldUpdater<ListenableFutureTask, Thread> RUNNER = AtomicReferenceFieldUpdater.newUpdater(
          ListenableFutureTask.class, Thread.class, "runner");
